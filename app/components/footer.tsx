...
<div className="space-y-2">
  <div className="border border-gray-800 rounded-lg px-4 py-4 text-center max-w-[600px] mx-auto flex items-center justify-center">
  ...
  <div className="border border-gray-800 rounded-lg px-4 py-2 text-center max-w-[600px] mx-auto flex items-center justify-center">
    ...
    <footer className="mt-24 border-t border-gray-800">
      ...
      <div className="py-16 border-b border-gray-800">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              <h3 className="text-xl font-medium mb-2">Subscribe to updates</h3>
              <p className="text-gray-400">Stay in touch with the latest Ithaca products & experiments.</p>
            </div>
            ...
            <div className="flex w-full md:w-auto">
              <input
                ...
                className="bg-black border border-gray-800 px-4 py-2 w-full md:w-64 focus:outline-none focus:border-gray-600"
              />
              <button className="bg-black border border-gray-800 border-l-0 px-3">
                <ArrowRight size={20} />
              </button>
            </div>
          </div>
      ...
      <div className="py-6">
        <div className="max-w-3xl mx-auto px-8 flex justify-between items-center">
          <div className="text-lg">ithaca</div>
          <div className="flex items-center gap-4">
            <span className="text-gray-400">13883188</span>
            <span className="text-gray-400">•</span>
            <Link href="https://github.com/ithaca" aria-label="GitHub" className="text-gray-400 hover:text-white">
              <Github size={20} />
            </Link>
            <Link href="https://discord.gg/ithaca" aria-label="Discord" className="text-gray-400 hover:text-white">
            ...
            <Link href="https://twitter.com/ithaca" aria-label="Twitter" className="text-gray-400 hover:text-white">
              <Twitter size={20} />
            </Link>
          </div>
        </div>
